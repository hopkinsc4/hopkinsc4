	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'starter' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'starter' ); ?></th>
			</tr>
		</thead>
		<tbody>
