		...
		<h2 class="comments-title">
			...
			if ( 1 === (int) $comments_number ) {
				printf(
					...
					esc_html_x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'starter' ),
			...
			<nav class="comment-navigation" id="comment-nav-above">
				...
				<?php if ( get_previous_comments_link() ) { ?>
					<div class="nav-previous">
						<?php previous_comments_link( __( '&larr; Older Comments', 'starter' ) ); ?>
					</div>
				<?php } ?>

				<?php	if ( get_next_comments_link() ) { ?>
					<div class="nav-next">
						<?php next_comments_link( __( 'Newer Comments &rarr;', 'starter' ) ); ?>
					</div>
				<?php } ?>
