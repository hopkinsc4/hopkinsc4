<?php
/**
 * Bytes.co Better Excerpts 
 * replaces block-level elements with whitespace, to improve the_excerpt
 *
 * @package starter
 */
...
if( ! class_exists('BytesCoBetterExcerpts') ) {
	
	class BytesCoBetterExcerpts {
		...
		private function __construct() {
			// ~PHP_INT_MAX (aka PHP_INT_MIN) as priority ensures our filter runs first
			add_filter( 'wp_trim_words', array( $this, 'wp_trim_words' ), ~PHP_INT_MAX, 4 );
		}
	...
	BytesCoBetterExcerpts::Instance();
}
