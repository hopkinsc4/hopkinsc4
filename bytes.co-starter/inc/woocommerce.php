...
if ( ! function_exists( 'starter_woocommerce_support' ) ) {
	...
	function starter_woocommerce_support() {
		...
		add_filter( 'woocommerce_form_field_args', 'starter_wc_form_field_args', 10, 3 );
	}
}
 ...
 * @return mixed
 */
if ( ! function_exists( 'starter_wc_form_field_args' ) ) {
	function starter_wc_form_field_args( $args, $key, $value = null ) {
